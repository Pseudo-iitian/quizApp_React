  ...
  return (
    <>
      <div className="container box-border bg-gray-300 flex justify-center mx-auto">
        <div className="quizBody border-2 md:w-[600px] border-gray-500 bg-white pt-16 pb-16 pl-10 pr-10 flex justify-center flex-col align-middle gap-4 shadow-2xl">
