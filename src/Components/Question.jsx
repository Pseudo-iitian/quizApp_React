  ...
  return (
    <>
      <div className="container h-screen bg-gray-300 flex justify-center items-center mx-auto">
        <div className="quizBody sm:h-screen sm:w-screen border-2 w-[600px] border-gray-500 bg-white flex justify-center flex-col align-middle gap-4 p-10 shadow-2xl">
